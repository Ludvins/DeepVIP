...
la = Laplace(f, 'classification', subset_of_weights=subset, hessian_structure=hessian, prior_precision = 1/args.prior_std**2)
...
print("Training done")
ood_metrics = score(la, ood_loader, OOD, use_tqdm=True, device = args.device, dtype = args.dtype)

test_metrics = score(la, test_loader, SoftmaxClassification, use_tqdm=True, device = args.device, dtype = args.dtype)
...
df.to_csv("results/LLA_{}_{}_{}_{}_MAP_it={}_it={}_prior={}_M={}.csv".format(
    subset, hessian,
