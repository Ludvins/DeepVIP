...
df.to_csv(
    path_or_buf="results/SubVaLLA_{}_dataset={}_M={}_prior={}_seed={}.csv".format(str(args.sub_classes), args.dataset_name,args.num_inducing, str(args.prior_std), args.seed),
    encoding="utf-8",
)