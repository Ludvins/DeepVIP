...
axis[0].plot(full_dataset.inputs.flatten()[sort], ella_mean.flatten()[sort], label = "Predictions", color = "black")
...
plt.show()
save_str = "ELLA_dataset={}_M={}".format(args.dataset_name,args.num_inducing, args.seed)
...
test_metrics = score(ella, test_loader, MetricsRegression, use_tqdm=True, device = args.device, dtype = args.dtype, ll_var = ll_var)
