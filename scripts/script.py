...
inducing = [50, 100]
prior_stds = [0.0001, 0.001, 0.01, 0.1]
weight_decay = 0.001
...
for i in prior_stds:
    for induci in inducing:
        subprocess.run(a + valla_ood + "--dataset CIFAR10_OOD --MAP_iterations 100000 --iterations 20000 --split 0 --num_inducing {} --weight_decay {} --prior_std {}".format(induci, weight_decay, i))
