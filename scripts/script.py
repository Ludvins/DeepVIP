...
valla_ood = "c:/Users/Ludvins/Documents/DeepVIP/scripts/valla_multiclass_ood.py "
valla_ood2 = "c:/Users/Ludvins/Documents/DeepVIP/scripts/valla_multiclass_ood2.py "

for i in prior_stds:
    for induci in inducing:
        subprocess.run(a + valla_ood + "--dataset MNIST_OOD --MAP_iterations 100000 --iterations 20000 --split 0 --num_inducing {} --weight_decay {} --prior_std {}".format(induci, weight_decay, i))
        subprocess.run(a + valla_ood2 + "--dataset MNIST_OOD --MAP_iterations 100000 --iterations 20000 --split 0 --num_inducing {} --weight_decay {} --prior_std {}".format(induci, weight_decay, i))
