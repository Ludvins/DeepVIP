...
print("Training done")
ood_metrics = score(ella, ood_loader, OOD, use_tqdm=True, device = args.device, dtype = args.dtype)

test_metrics = score(ella, test_loader, SoftmaxClassification, use_tqdm=True, device = args.device, dtype = args.dtype)
