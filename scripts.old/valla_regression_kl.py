...
sparseLA = SparseLA(
    ...
    prior_std=2.2026465,
    likelihood=Gaussian(
        device=args.device, log_variance=np.log(0.11802231**2), dtype=args.dtype
    ),
...
d = {"M": args.num_inducing, "seed": args.seed, "KL": KL, "MAE": MAE}
...
df.to_csv(
    path_or_buf="results/VaLLA_dataset={}_M={}_seed={}.csv".format(
