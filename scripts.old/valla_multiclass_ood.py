...
from src.sparseLA import ELLA_Optimized, VaLLAMultiClassSubsetOptimized
...
print("Training done")
ood_metrics = score(
    sparseLA, ood_loader, OOD, use_tqdm=True, device=args.device, dtype=args.dtype
)
...
df.to_csv(
    "results/VaLLA_{}_{}_MAP_it={}_it={}_prior={}_M={}.csv".format(
        args.dataset_name,
