...
from src.sparseLA import VaLLASampling, GPLLA_Optimized
...
plt.savefig(
    "LLA_{}_prior={}.pdf".format(args.dataset_name, str(args.prior_std)),
    bbox_inches="tight",
)
plt.show()
